...
namespace MVCpracticauno.Controllers
{
    ...
    {
        private readonly equiposDbContex _context;

        public marcasController(equiposDbContex context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.marcas != null ? 
                          ...
                          Problem("Entity set 'equiposDbContex.marcas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equiposDbContex.marcas'  is null.");
            }
            var marcas = await _context.marcas.FindAsync(id);
            if (marcas != null)
            {
